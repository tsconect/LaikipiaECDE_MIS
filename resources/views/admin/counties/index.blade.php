...
@section('content')
    ...
    <div class="table-card">
        ...
        <div class="table-banner">
            <div class="table-banner-title"><span>COUNTIES</span></div>
        ...
        <!-- Table -->
        <table class="data-table" id="countiesTable">
            <thead>
                <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="action-btns">
                                <a class="act-btn view" title="View County" href="{{ route('admin.counties.show', $item->id) }}">
                                    <svg viewBox="0 0 20 20" fill="currentColor"><path d="M10 12a2 2 0 100-4 2 2 0 000 4z"/><path fill-rule="evenodd" d="M.458 10C1.732 5.943 5.522 3 10 3s8.268 2.943 9.542 7c-1.274 4.057-5.064 7-9.542 7S1.732 14.057.458 10zM14 10a4 4 0 11-8 0 4 4 0 018 0z" clip-rule="evenodd"/></svg>
                                </a>
                                <a class="act-btn edit" title="Edit County" href="{{ route('admin.counties.edit', $item->id) }}">
                                    <svg viewBox="0 0 20 20" fill="currentColor"><path d="M13.586 3.586a2 2 0 112.828 2.828l-.793.793-2.828-2.828.793-.793zM11.379 5.793L3 14.172V17h2.828l8.38-8.379-2.83-2.828z"/></svg>
                                </a>
                                <form action="{{ route('admin.counties.destroy', $item->id) }}" method="POST" class="inline-form" onsubmit="return confirm('Delete this county?');">
                                    @csrf
                                    @method('DELETE')
                                    <button type="submit" class="act-btn delete" title="Delete County">
    ...
    <script>
        ...
        function printTable() {
            const printContent = document.getElementById('countiesTable').outerHTML;
            const printWindow = window.open('', '_blank');
            printWindow.document.write('<html><head><title>Counties</title></head><body>');
