...
@section('content')
    ...
    <div class="table-card">
        ...
        <!-- Table -->
        <table class="data-table" id="subCountyTable">
            <thead>
                <tr>
    ...
    <script>
        ...
        function printTable() {
            const printContent = document.getElementById('subCountyTable').outerHTML;
            const printWindow = window.open('', '_blank');
            printWindow.document.write('<html><head><title>Sub-Counties</title></head><body>');
