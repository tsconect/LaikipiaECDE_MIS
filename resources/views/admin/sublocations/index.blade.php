...
@section('content')
    ...
    <div class="table-card">
        ...
        <!-- Table -->
        <table class="data-table" id="sublocationsTable">
            <thead>
                <tr>
    ...
    <script>
        ...
        // Copy table function
        function copyTable() {
            const table = document.getElementById('sublocationsTable');
            let text = '';
        ...
        function printTable() {
            const printContent = document.getElementById('sublocationsTable').outerHTML;
            const printWindow = window.open('', '_blank');
            printWindow.document.write('<html><head><title>Sub Locations</title></head><body>');
