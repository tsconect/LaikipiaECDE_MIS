...
@section('content')
    ...
    <div class="table-card">
        ...
        <!-- Table -->
        <table class="data-table" id="ethnicGroupsTable">
            <thead>
                <tr>
    ...
    <script>
        ...
        // Copy table function
        function copyTable() {
            const table = document.getElementById('ethnicGroupsTable');
            let text = '';
        ...
        function printTable() {
            const printContent = document.getElementById('ethnicGroupsTable').outerHTML;
            const printWindow = window.open('', '_blank');
            printWindow.document.write('<html><head><title>Ethnic Groups</title></head><body>');
