    ...
    <div class="table-card">
        ...
        <!-- Table -->
        <table class="data-table" id="feederSchoolsTable">
            <thead>
                <tr>
                    ...
                    <th>SCHOOL NAME <span class="sort-arrows"><svg viewBox="0 0 8 8" fill="currentColor"><path d="M4 0l2 3H2L4 0z"/></svg><svg viewBox="0 0 8 8" fill="currentColor"><path d="M4 8L2 5h4L4 8z"/></svg></span></th>
                    <th>NO. C/ROOMS <span class="sort-arrows"><svg viewBox="0 0 8 8" fill="currentColor"><path d="M4 0l2 3H2L4 0z"/></svg><svg viewBox="0 0 8 8" fill="currentColor"><path d="M4 8L2 5h4L4 8z"/></svg></span></th>
                    ...
                    <th>WARD <span class="sort-arrows"><svg viewBox="0 0 8 8" fill="currentColor"><path d="M4 0l2 3H2L4 0z"/></svg><svg viewBox="0 0 8 8" fill="currentColor"><path d="M4 8L2 5h4L4 8z"/></svg></span></th>
                    <th>ACTION</th>
                </tr>
            </thead>
            <tbody>
    ...
    <script>
        ...
        // Copy table function
        function copyTable() {
            const table = document.getElementById('feederSchoolsTable');
            let text = '';
        ...
        function printTable() {
            const printContent = document.getElementById('feederSchoolsTable').outerHTML;
            const printWindow = window.open('', '_blank');
            printWindow.document.write('<html><head><title>Feeder Schools</title></head><body>');
