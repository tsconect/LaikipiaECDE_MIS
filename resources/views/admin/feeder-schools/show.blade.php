...
@section('content')
    ...
    <div class="card-body">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h4>{{ $school->school_name }} - Feeder School Details</h4>
            <a href="{{ route('admin.feeder-schools.edit', $school->id) }}" class="btn btn-primary">
        ...
        <div class="row mb-4">
            <div class="col-12">
                <a href="{{ route('admin.feeder-schools.index') }}" class="btn btn-secondary btn-sm">
                    <i class="fas fa-arrow-left"></i> Back to Feeder Schools
                </a>
            </div>
        </div>
        ...
        <div class="card p-4">
            ...
            <div class="row mt-4">
                <div class="col-12">
                    ...
                    <a href="{{ route('admin.feeder-schools.index') }}" class="btn btn-secondary">
                        <i class="fas fa-arrow-left"></i> Back to Feeder Schools
                    </a>
                </div>
            </div>
