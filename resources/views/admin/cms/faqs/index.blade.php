...
@section('cms-content')
    <div class="table-card">
        ...
        <table class="data-table" id="faqsTable">
            <thead>
                <tr>
                    <th>QUESTION <span class="sort-arrows"><svg viewBox="0 0 8 8" fill="currentColor"><path d="M4 0l2 3H2L4 0z"/></svg><svg viewBox="0 0 8 8" fill="currentColor"><path d="M4 8L2 5h4L4 8z"/></svg></span></th>
                    ...
                    <th>ORDER <span class="sort-arrows"><svg viewBox="0 0 8 8" fill="currentColor"><path d="M4 0l2 3H2L4 0z"/></svg><svg viewBox="0 0 8 8" fill="currentColor"><path d="M4 8L2 5h4L4 8z"/></svg></span></th>
                    <th>ACTIONS</th>
                </tr>
            </thead>
            <tbody>
    ...
    <script>
        ...
        function printTable() {
            const printContent = document.getElementById('faqsTable').outerHTML;
            const printWindow = window.open('', '_blank');
            printWindow.document.write('<html><head><title>FAQs</title></head><body>');
