...
@section('cms-content')
        ...
        <table class="data-table" id="contactMessagesTable">
            <thead>
                <tr>
                    ...
                    <th>SUBJECT <span class="sort-arrows"><svg viewBox="0 0 8 8" fill="currentColor"><path d="M4 0l2 3H2L4 0z"/></svg><svg viewBox="0 0 8 8" fill="currentColor"><path d="M4 8L2 5h4L4 8z"/></svg></span></th>
                    ...
                    <th>SUBMITTED <span class="sort-arrows"><svg viewBox="0 0 8 8" fill="currentColor"><path d="M4 0l2 3H2L4 0z"/></svg><svg viewBox="0 0 8 8" fill="currentColor"><path d="M4 8L2 5h4L4 8z"/></svg></span></th>
                    <th>ACTION</th>
                </tr>
            </thead>
            <tbody>
    ...
    <script>
        ...
        function printTable() {
            const printContent = document.getElementById('contactMessagesTable').outerHTML;
            const printWindow = window.open('', '_blank');
            printWindow.document.write('<html><head><title>Contact Messages</title></head><body>');
