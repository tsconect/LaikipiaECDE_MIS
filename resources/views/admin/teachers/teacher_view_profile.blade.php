                                            ...
                                            <table class="mb-0 table table-borderless">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td  >  Next of Kin: &nbsp;&nbsp; <b class="text-success">{{ $data->next_kin_first_name }} {{ $data->next_kin_middle_name }} {{ $data->next_kin_last_name }} </b> </td>
                                                    </tr>
                                                </tbody>
                                        ...
                                        <tr>
                                            ...
                                            @if (isset($data->unions))
                                                <td  >  unions: &nbsp;&nbsp; @foreach ($data->unions as $_)
                                                    <br>
                                                    <b class="text-success ml-4"> {{ $_->name }}</b>
                                                @endforeach
                                            </td>
                        ...
                        <div class="mb-3 card">
                            ...
                            <div class="card-body">
                                <table class="mb-0 table table-borderless">
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td  > name: &nbsp;&nbsp; <b class="text-success">
                                                {{$data->school->school_contact_first_name }}    {{$data->school->school_contact_middle_name }}  {{$data->school->school_contact_last_name }}  </b> </td>
                                            <td  > phone: &nbsp;&nbsp; <b class="text-success">{{$data->school->school_contact_phone_number }} </b> </td>
                                        </tr>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td  > tsc_number: &nbsp;&nbsp; <b class="text-success">{{$data->school->school_contact_tsc_number }} </b> </td>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td  > Desgnitaion: &nbsp;&nbsp; <b class="text-success">{{$data->school->school_contact_designation }} </b> </td>
                                        </tr>
                                    </tbody>
