...
@section('content')
    ...
    <div class="table-card">
        ...
        <!-- Table -->
        <table class="data-table" id="coordinatorsTable">
            <thead>
                <tr>
                    ...
                    <th>CONSTITUENCY <span class="sort-arrows"><svg viewBox="0 0 8 8" fill="currentColor"><path d="M4 0l2 3H2L4 0z"/></svg><svg viewBox="0 0 8 8" fill="currentColor"><path d="M4 8L2 5h4L4 8z"/></svg></span></th>
                    <th>ACTION</th>
                </tr>
            </thead>
            <tbody>
        ...
        <div class="table-footer">
            <div class="footer-left">
                Showing {{ $coordinators->firstItem() ?? 0 }} to {{ $coordinators->lastItem() ?? 0 }} of {{ $coordinators->total() }} entries
            </div>
    ...
    <script>
        ...
        function printTable() {
            const printContent = document.getElementById('coordinatorsTable').outerHTML;
            const printWindow = window.open('', '_blank');
            printWindow.document.write('<html><head><title>ECDE Coordinators</title></head><body>');
