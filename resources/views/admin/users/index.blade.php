...
@section('content')
        ...
        <table class="data-table" id="usersTable">
            <thead>
                <tr>
                    ...
                    <th>ROLE <span class="sort-arrows"><svg viewBox="0 0 8 8" fill="currentColor"><path d="M4 0l2 3H2L4 0z"/></svg><svg viewBox="0 0 8 8" fill="currentColor"><path d="M4 8L2 5h4L4 8z"/></svg></span></th>
                    <th>ACTION</th>
                </tr>
            </thead>
            <tbody>
    ...
    <script>
        ...
        function printTable() {
            ...
            printWindow.document.write('<html><head><title>System Users</title></head><body>');
