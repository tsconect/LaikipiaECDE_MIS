...
@section('content')
    ...
    <div class="table-card">
        ...
        <!-- Table -->
        <table class="data-table" id="jobGroupsTable">
            <thead>
                <tr>
    ...
    <script>
        ...
        // Copy table function
        function copyTable() {
            const table = document.getElementById('jobGroupsTable');
            let text = '';
        ...
        function printTable() {
            const printContent = document.getElementById('jobGroupsTable').outerHTML;
            const printWindow = window.open('', '_blank');
            printWindow.document.write('<html><head><title>Job Groups</title></head><body>');
