            ...
            <div class="card shadow-sm mb-4">
                ...
                <div class="card-body">
                    <div class="row g-4">
                        ...
                        <div class="col-md-6">
                            <div class="position-relative form-group">
                                ...
                                <input name="center_code" id="center_code" value="{{ $school->center_code }}" placeholder="Enter center code" required
                                    type="text" class="form-control">
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="position-relative form-group">
                                ...
                                <select name="has_feeder" id="has_feeder" class="form-control" onchange="showFeederDiv()">
                                    <option value="0" {{ $school->has_feeder == 0 ? 'selected' : '' }}>No</option>
                                    <option value="1" {{ $school->has_feeder == 1 ? 'selected' : '' }}>Yes</option>
                                </select>
                            </div>
                        </div>

                        <div class="col-md-6 {{ $school->has_feeder == 1 ? '' : 'd-none' }}" id="feeder_div">
                            <div class="position-relative form-group">
                                ...
                                <select name="feeder_id" id="feeder_id" class="form-control">
                                    ...
                                    @foreach ($feeder_schools as $value)
                                        <option value="{{ $value->id }}" {{ $school->feeder_id == $value->id ? 'selected' : '' }}>{{ $value->school_name }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                    ...
                    <div class="text-right p-2">
                        <button class="btn btn-success" type="submit">Update ECDE School</button>
                    </div>
                </div>
            </div>
        </form>
