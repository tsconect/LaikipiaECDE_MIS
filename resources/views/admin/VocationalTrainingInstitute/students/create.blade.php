...
@section('content')
    ...
    <div class="card-body">
        <form id="teachers" class="" action="{{ route('admin.vtc_students.store') }}" method="post"  enctype="multipart/form-data">
            @csrf
                <div id="smartwizard">
                    ...
                    <div id="step-3">
                        <div class="form-row">
                            ...
                            <div class="col-md-6">
                                ...
                                <select onchange="filterCourses({{ request()->input('vtc') }})" name="school_dpt" id="school_dpt" class="form-control" required>
