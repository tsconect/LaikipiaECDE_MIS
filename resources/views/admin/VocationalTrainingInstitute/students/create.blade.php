...
@section('content')
    ...
    <div class="card-body">
        <form id="teachers" class=" modern-form-shell" action="{{ route('admin.vtc_students.store') }}" method="post"  enctype="multipart/form-data">
            @csrf
                <div id="smartwizard">
                    ...
                    <div id="step-2">
                        <div id="accordion" class="accordion-wrapper mb-3">
                            <div class="form-row">
                                ...
                                <input name="stundent_type_id" id="stundent_type_id" value="2"  hidden>
                    ...
                    <div id="step-3">
                        <div class="form-row">
                            ...
                            <div class="col-md-6">
                                ...
                                <label for="school_dpt" class="">Which Department is the student in? </label>
                                <select onchange="filterCourses(this.dataset.vtc)" data-vtc="{{ request()->input('vtc') }}" name="school_dpt" id="school_dpt" class="form-control" required>
                                    <option>Select Department</option>
                                    @foreach (App\Models\VTCDepartments::where('vtc_id', request()->input('vtc'))->get() as $value)
                            ...
                            <div class="col-md-6">
                                ...
                                <label for="school_course" class="">Which course does the student attend? </label>
                                <select name="school_course" id="school_course" class="form-control" required>
                                    <option>Select course</option>
                                    @foreach (App\Models\VTCCourses::where('vtc_id', request()->input('vtc'))->get()  as $value)
