...
<div class="card-body">
            ...
            <h5 class="card-title text-right">  <a href="{{route('admin.const.create')}}"><button class="btn btn-warning ">  <i class="fa fa-plus"></i> Vocational Courses</button></a> </h5>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <a type="button" class="btn btn-outline-primary" title="Create Department"
                                    ...
                                    <a type="button" class="btn btn-outline-primary" title="view Students in {{ $item->department_name }}"
