        ...
        <div class="card-body">
            ...
            <form class=" modern-form-shell" action="{{ route('admin.vtc_courses.store') }}" method="post">
                ...
                <div class="form-row">
                    ...
                    @if ($dpt)
                    <input value="{{ App\Models\VTCDepartments::find($dpt)->vtc_id }}" name="vtc_dpt_id" type="text" hidden>
                    ...
                    @if ($dpt)
                        <input value="{{ App\Models\VTCDepartments::find($dpt)->id }}" name="vtc_dpt_id" type="text" hidden>

                    @else
                    <div class="col-md-6">
                        <div class="position-relative form-group">
                            <label for="vtc_dpt_id" class="">vtc department </label>
                    ...
                    <div class="col-md-6">
                        <div class="position-relative form-group">
                            ...
                            <input name="course_name" id="course_name" placeholder="Enter course_name" required
                    ...
                    <div class="col-md-6">
                        <div class="position-relative form-group">
                            ...
                            {{-- <input name="duration" id="duration" placeholder="Enter duration" required type="text"
                               > --}}
                    ...
                    <div class="col-md-6">
                        <div class="position-relative form-group">
                            <label for="registration_code" class="">Course Code</label>
                    ...
                    <div class="col-md-6">
                        <div class="position-relative form-group">
                            ...
                            {{-- <input name="examination_body_or_creteria" id="examination_body_or_creteria"
                                placeholder="Enter examination_body_or_creteria" required type="text"
                                class="form-control"> --}}

                                <select name="examination_body_or_creteria" id="examination_body_or_creteria" class="form-control">
                                    <option value="">Select an Examination Body</option>
                                    <option value="KNEC">Kenya National Examinations Council (KNEC)</option>
                                    <option value="KASNEB">Kenya Accountants and Secretaries National Examination Board (KASNEB)</option>
                                    <option value="KISM">Kenya Institute of Supplies Management (KISM)</option>
                                    <option value="KICD">Kenya Institute of Curriculum Development (KICD)</option>
                                    <option value="KNEC-ECDE">Kenya National Examinations Council - Early Childhood Development Education (KNEC-ECDE)</option>
                                    <option value="VTC">Vocational Training Centers (VTC) Evaluations</option>
                                  </select>
                    ...
                    <div class="col-md-6">
                        <div class="position-relative form-group">
                            ...
                            <input name="addtional_description" id="addtional_description"
                                placeholder="Enter addtional_description" required type="text" class="form-control">
                        </div>
                    </div>
