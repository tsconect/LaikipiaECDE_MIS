                                            ...
                                            <table class="mb-0 table table-borderless">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td  >  Next of Kin: &nbsp;&nbsp; <b class="text-success">{{ $data->next_of_kin_full_names }} </b> </td>
                                                    </tr>
                                                </tbody>
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        {{-- <td><b>Usname:</b> </td> --}}
                                                        <td  > Next of Kin ID No: &nbsp;&nbsp; <b class="text-success">{{ $data->next_of_kin_id_number }} </b> </td>
                                                        <td  > Next of Kin Phone No: &nbsp;&nbsp; <b class="text-success">{{ $data->next_of_kin_phone_number }} </b> </td>
                                                        <td  > Next of Kin Relationship: &nbsp;&nbsp; <b class="text-success">{{ $data->next_of_kin_relationship }} </b> </td>
                                                    ...
                                                    <div class="row">
                                                        <div class="form-check col-8">
                                                            <form action="">
                                                                ...
                                                                <label class="font-weight-bold" for="appraisal">
                                                                    {{ __('Appraise This Teacher') ?? "Appraisal" }}
                                                                </label>
                                                                <textarea  class="form-control" type="text" name="appraisal" id="appraisal"></textarea>
                                                                <div class="row mt-3">
                                                                    <div class="col text-center ">
                                                                        <button type="submit" class="col btn btn-success rounded">
                                                                            {{ __('Appraise') }}
                                                                        </button>
                    ...
                    <div class="col-md-6">
                        <div class="mb-3 card">
                            ...
                            <div class="card-body">
                                <table class="mb-0 table table-borderless">
                                    <tbody>
                                        ...
                                        <tr>
                                            {{-- <td><b>Usname:</b> </td> --}}
                                            <td  > Education Level: &nbsp;&nbsp; <b class="text-success">{{ $data->education_level }} </b> </td>
                                            @if (isset($data->union_id))
                                                <td  >  unions: &nbsp;&nbsp;
                                                    <br>
                                                    <b class="text-success ml-4"> {{ App\Models\Unions::find($data->union_id)->name ?? 'N\A'}}</b>

                                                {{-- @foreach ($data->unions as $_)
                            ...
                            <div class="d-block text-right card-footer">
                                ...
                                <a href="{{ url('admin/download?cert='.$data->certification_attachment) }}" class="btn-wide btn-shadow btn btn-danger lnt lnr-download" > &nbsp;&nbsp;  Download Teacher Academic Certification.</a>
                            </div>
                        </div>
                        <div class="mb-3 card">
                            <div class="card-header-tab card-header">
                            ...
                            <div class="card-body">
                                <table class="mb-0 table table-borderless">
                                    <tbody>
                                        ...
                                        <tr>
                                            {{-- <td><b>Usname:</b> </td> --}}
                                            <td  > Constituency: &nbsp;&nbsp; <b class="text-success">{{$data->const->name }} </b> </td>
                                            <td  > Ward: &nbsp;&nbsp; <b class="text-success">{{$data->ward->name }} </b> </td>
                                        </tr>
                                        <tr>
                                            {{-- <td  > Sub_location: &nbsp;&nbsp; <b class="text-success">{{$data->resident->Sub_location }} </b> </td> --}}
                                            <td  > village: &nbsp;&nbsp; <b class="text-success">{{$data->village }} </b> </td>
                                        </tr>
                                    </tbody>
                            ...
                            <div class="card-body">
                                <table class="mb-0 table table-borderless">
                                    <tbody>
                                        ...
                                        <tr>
                                            {{-- <td><b>Usname:</b> </td> --}}
                                            <td  > name: &nbsp;&nbsp; <b class="text-success">
                                                {{$data->school->full_names }}   </b> </td>
                                            <td  > phone: &nbsp;&nbsp; <b class="text-success">{{$data->phone_number }} </b> </td>
                                        </tr>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td  > tsc_number: &nbsp;&nbsp; <b class="text-success">{{$data->school->tsc_number }} </b> </td>
                                            {{-- <td  > P.O Box: &nbsp;&nbsp; <b class="text-success">{{$data->school->box }} </b> </td> --}}
                                        </tr>

                                    </tbody>
                                    <tbody>
                                        <tr>
                                            <td  > Desgnitaion: &nbsp;&nbsp; <b class="text-success">{{$data->school->designation }} </b> </td>
                                        </tr>
                                    </tbody>
