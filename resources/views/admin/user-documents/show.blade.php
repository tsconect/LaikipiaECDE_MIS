        ...
        <div class="detail-grid">
            ...
            <div class="detail-item">
                <div class="detail-label"><i class="bi bi-file-earmark-text"></i> Document Type</div>
                                <div class="detail-label"><i class="bi bi-circle"></i> Document Type</div>
