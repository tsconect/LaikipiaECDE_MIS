...
@section('content')
    ...
    <div class="table-card">
            ...
            <div class="banner-actions">
                <a href="{{ route('admin.generate_dpt_staff_returns') }}">
                    <button class="btn-generate">
                        <svg viewBox="0 0 20 20" fill="currentColor"><path fill-rule="evenodd" d="M4 4a2 2 0 00-2 2v8a2 2 0 002 2h12a2 2 0 002-2V6a2 2 0 00-2-2H4zm0 2h12v8H4V6z" clip-rule="evenodd"/><path d="M8 10a1 1 0 100-2 1 1 0 000 2z"/></svg>
        ...
        <!-- Table -->
        <table class="data-table" id="departmentWorkersTable">
            <thead>
                <tr>
                    ...
                    <th>DATE CREATED <span class="sort-arrows"><svg viewBox="0 0 8 8" fill="currentColor"><path d="M4 0l2 3H2L4 0z"/></svg><svg viewBox="0 0 8 8" fill="currentColor"><path d="M4 8L2 5h4L4 8z"/></svg></span></th>
                    <th>DATE UPDATED <span class="sort-arrows"><svg viewBox="0 0 8 8" fill="currentColor"><path d="M4 0l2 3H2L4 0z"/></svg><svg viewBox="0 0 8 8" fill="currentColor"><path d="M4 8L2 5h4L4 8z"/></svg></span></th>
                    <th>ACTION</th>
                </tr>
            </thead>
            <tbody>
    ...
    <script>
        ...
        // Copy table function
        function copyTable() {
            const table = document.getElementById('departmentWorkersTable');
            let text = '';
        ...
        function exportCSV() {
            ...
            a.href = url;
            a.download = 'department-workers.csv';
            a.click();
        ...
        function printTable() {
            const printContent = document.getElementById('departmentWorkersTable').outerHTML;
            const printWindow = window.open('', '_blank');
            printWindow.document.write('<html><head><title>Department Workers</title></head><body>');
