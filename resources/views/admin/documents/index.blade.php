...
@section('content')
        ...
        <table class="data-table" id="documentsTable">
            <thead>
                <tr>
                    ...
                    <th>REQUIRED <span class="sort-arrows"><svg viewBox="0 0 8 8" fill="currentColor"><path d="M4 0l2 3H2L4 0z"/></svg><svg viewBox="0 0 8 8" fill="currentColor"><path d="M4 8L2 5h4L4 8z"/></svg></span></th>
                    <th>ACTION</th>
                </tr>
            </thead>
            <tbody>
    ...
    <script>
        ...
        function printTable() {
            const printContent = document.getElementById('documentsTable').outerHTML;
            const printWindow = window.open('', '_blank');
            printWindow.document.write('<html><head><title>Documents</title></head><body>');
