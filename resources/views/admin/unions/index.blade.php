...
@section('content')
    ...
    <div class="table-card">
        ...
        <!-- Table -->
        <table class="data-table" id="unionsTable">
            <thead>
                <tr>
                    ...
                    <th>MEMBERS <span class="sort-arrows"><svg viewBox="0 0 8 8" fill="currentColor"><path d="M4 0l2 3H2L4 0z"/></svg><svg viewBox="0 0 8 8" fill="currentColor"><path d="M4 8L2 5h4L4 8z"/></svg></span></th>
                    <th>ACTION</th>
                </tr>
            </thead>
            <tbody>
    ...
    <script>
        ...
        // Copy table function
        function copyTable() {
            const table = document.getElementById('unionsTable');
            let text = '';
        ...
        function printTable() {
            const printContent = document.getElementById('unionsTable').outerHTML;
            const printWindow = window.open('', '_blank');
            printWindow.document.write('<html><head><title>Unions</title></head><body>');
