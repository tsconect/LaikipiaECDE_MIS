                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card p-4 mb-2">
                                    <p class="text-bold text-green">Bursary application for <strong>{{$application->name}}.</strong>  Incase you need to Edit your detals click <a href="{{route('student.profile')}}">HERE</a> </p>
                                </div>
                                <div class="card p-4">
                                    ...
                                    <div class="container mt-2">
                                        <ul class="nav flex-column flex-sm-row nav-pills nav-justified mb-3" id="pills-tab" role="tablist">
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link" id="examination-point-tab" data-toggle="pill" href="#examination-point" role="tab" aria-controls="examination-point" aria-selected="false">Attachments</a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link" id="payments-tab" data-toggle="pill" href="#payments" role="tab" aria-controls="payments" aria-selected="false">Bursary Application</a>
                                            </li>
                                        </ul>
                                    </div>
                                    ...
                                    <div class="tab-content" id="pills-tabContent">
                                                        ...
                                                        <div class="form-row">
                                                            ...
                                                            <div class="col-md-4">
                                                                <div class="position-relative form-group">
                                                                    ...
                                                                    <input name="phone_number" id="phone_number" placeholder="Phone Number" disabled required type="text"  value="{{ old('phone_number', auth()->user()->phone_number) }}" 
                                                                        class="form-control">
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-md-4">
                                                                <div class="position-relative form-group">
                                                                    ...
                                                                    <input name="id_birth_cert_no" id="id_birth_cert_no" placeholder="ID Number" disabled required type="text"  value="{{ old('id_birth_cert_no', auth()->user()->studentDetails->id_birth_cert_no) }}" 
                                                                        class="form-control">
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-md-4">
                                                                <div class="position-relative form-group">
                                                                    ...
                                                                    <input name="date_of_birth" id="date_of_birth" placeholder="Date Of Birth" disabled required type="text"  value="{{ old('date_of_birth', auth()->user()->studentDetails->date_of_birth) }}"  
                                                                        class="form-control">
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-md-4">
                                                                <div class="position-relative form-group">
                                                                    ...
                                                                    <input name="kra_pin" id="kra_pin" placeholder="KRA Pin" required disabled  type="text" value="{{ old('kra_pin', auth()->user()->studentDetails->kra_pin) }}"  class="form-control">
                                                           ...
                                                           <div class="col-md-4">
                                                                <div class="position-relative form-group">
                                                                    ...
                                                                    <select name="religion"  autocomplete="off" id="religion" disabled class="form-control" required>
                                                            ...
                                                            <div class="col-md-4">
                                                                <div class="position-relative form-group">
                                                                    ...
                                                                    <select name="employment_status" disabled  autocomplete="off" disabledid="employment_status" class="form-control" required>
                                                            ...
                                                            <div class="col-md-4">
                                                                <div class="position-relative form-group">
                                                                    ...
                                                                    <select name="marital_status"  autocomplete="off" disabled id="marital_status" class="form-control" required>
                                                            ...
                                                            <div class="col-md-4">
                                                                <div class="position-relative form-group">
                                                                    ...
                                                                    <select name="parental_status"  autocomplete="off " disabled id="parental_status" class="form-control" required onchange="updateParentalFields()">
                                                            ...
                                                            <div class="col-md-4">
                                                                <div class="position-relative form-group">
                                                                    ...
                                                                    <select name="who_pays_fees"  autocomplete="off" disabled id="who_pays_fees" class="form-control" required>
                                                            ...
                                                            <div class="col-md-4">
                                                                <div class="position-relative form-group">
                                                                    ...
                                                                    <input name="school_name" disabled id="school_name" value="{{$student->school->school_name}}" placeholder="School name" required type="text"
                                                                        class="form-control">
                                                                </div>
                                                            </div>
                                                            <div class="col-md-4">
                                                                <div class="position-relative form-group">
                                                                    ...
                                                                    <select name="level_of_study" disabled id="level_of_study" class="form-control" required onChange="return schoolType()" autocomplete="off">
                                                            ...
                                                            <div class="col-md-4">
                                                                <div class="position-relative form-group">
                                                                    ...
                                                                    <select name="school_category" disabled id="" class="form-control" required autocomplete="off">
                                                            ...
                                                            <div class="col-md-4">
                                                                <div class="position-relative form-group">
                                                                    ...
                                                                    <input name="admission_number" disabled value="{{$student->school->admission_number}}"  id="admission_number" placeholder="***" required type="text"
                                                                        class="form-control">
                                                                </div>
                                                            </div>
                                                            <div class="col-md-4">
                                                                <div class="position-relative form-group">
                                                                    ...
                                                                    <select name="year_of_study" disabled id="" class="form-control" required autocomplete="off">
                                                            ...
                                                            <div class="col-md-4">
                                                                <div class="position-relative form-group">
                                                                    ...
                                                                    <select name="school_county" disabled id="" class="form-control" required autocomplete="off">
                                                            ...
                                                            <div class="col-md-4">
                                                                <div class="position-relative form-group">
                                                                    ...
                                                                    <input name="physical_address" disabled id="physical_address"  value="{{$student->school->physical_address}}"  placeholder="Po Box 10400 - Nanyuki" required type="text" class="form-control">
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-md-4">
                                                                <div class="position-relative form-group">
                                                                    ...
                                                                    <input name="contact_person" disabled id="contact_person"  value="{{$student->school->contact_person}}"  placeholder="079----" required type="number"
                                                                        class="form-control">
                                                                </div>
                                                            </div>
                                        ...
                                        <div class="tab-pane fade" id="investment-details" role="tabpanel" aria-labelledby="investment-details-tab">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="container mt-3">
                                                        @if(auth()->user()->studentDetails->parent->first()->parent_type == 'Father' || auth()->user()->studentDetails->parent->first()->parent_type == 'guardian' ) 
                                                            ...
                                                            <div class="form-row">
                                                                <div class="col-md-4">
                                                                    <div class="position-relative form-group">
                                                                        ...
                                                                        <input name="parent_first_name" disabled id="parent_first_name" placeholder="First Name"  type="text" value="{{$student->parent->first()->first_name}}"
                                                                            class="form-control">
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="col-md-4">
                                                                    <div class="position-relative form-group">
                                                                        ...
                                                                        <input name="parent_last_name" disabled id="parent_last_name" placeholder="Last Name"  type="text"  value="{{$student->parent->first()->last_name}}"
                                                                            class="form-control">
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="col-md-4">
                                                                    <div class="position-relative form-group">
                                                                        ...
                                                                        <input name="parent_phone" disabled id="parent_phone" placeholder="07**********"  type="text"  value="{{$student->parent->first()->phone}}"
                                                                            class="form-control">
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="col-md-4">
                                                                    <div class="position-relative form-group">
                                                                        ...
                                                                        <input name="parent_id_number" disabled id="parent_id_number" placeholder="33603456"  type="number"  value="{{$student->parent->first()->parent_id_number}}"
                                                                            class="form-control">
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-4">
                                                                    <div class="position-relative form-group">
                                                                        ...
                                                                        <input name="parent_occupation" disabled id="parent_occupation" placeholder="Teacher"  type="text"  value="{{$student->parent->first()->occupation}}"
                                                                            class="form-control">
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-4">
                                                                    <div class="position-relative form-group">
                                                                        ...
                                                                        <input name="parent_annual_salary" disabled id="annual_salary" placeholder="Ksh 2000"  type="text"  value="{{$student->parent->first()->annual_salary}}"
                                                                            class="form-control">
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="col-md-4">
                                                                    ...
                                                                    <div class="position-relative form-group">
                                                                        ...
                                                                        <select name="parent_status" id="parent_status" disabled  autocomplete="off" class="form-control" onchange="return parentDisabled()">
                                                                ...
                                                                <div class="col-md-4" id="plwd_number_parent">
                                                                    <div class="position-relative form-group">
                                                                        ...
                                                                        <input name="parent_plwd_id" disabled id="plwd_number_parent_id" placeholder="Plwd Number"  type="text" style="display: none;" value="{{$student->parent->first()->plwd_number}}"
                                                                            class="form-control">
                                                                    </div>
                                                                </div>
                                                                @endif
                                                        ...
                                                        <div id="mothers-details">
                                                            ...
                                                            <div  id="second_parent_details" class="form-row">
                                                                <div class="col-md-4">
                                                                    <div class="position-relative form-group">
                                                                        <label for="name" class=""> First Name</label>
                                                                        <input name="second_parent_first_name" disabled  placeholder="Mothers First Name"  type="text"  value="{{$student->parent->last()->first_name}}"
                                                                            class="form-control">
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="col-md-4">
                                                                    <div class="position-relative form-group">
                                                                        <label for="name" class=""> Last Name</label>
                                                                        <input name="second_parent_last_name" disabled id="second_parent_last_name" placeholder="Mothers Last Name"  type="text" value="{{$student->parent->last()->last_name}}"
                                                                            class="form-control">
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="col-md-4">
                                                                    <div class="position-relative form-group">
                                                                        <label for="name" class=""> Phone Number</label>
                                                                        <input name="second_parent_phone" disabled id="second_parent_phone" placeholder="07**********"  type="text" value="{{$student->parent->last()->phone}}"
                                                                            class="form-control">
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="col-md-4">
                                                                    <div class="position-relative form-group">
                                                                        <label for="name" class=""> ID Number</label>
                                                                        <input name="second_parent_id_number" disabled id="second_parent_id_number" placeholder="30303003"  type="number" value="{{$student->parent->last()->id_number}}"
                                                                            class="form-control">
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="col-md-4">
                                                                    <div class="position-relative form-group">
                                                                        <label for="name" class=""> Occupation</label>
                                                                        <input name="second_parent_occupation" disabled id="second_parent_occupation" placeholder="House Wife"  type="text" value="{{$student->parent->last()->occupation}}"
                                                                            class="form-control">
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="col-md-4">
                                                                    <div class="position-relative form-group">
                                                                        <label for="name" class="">Annual Salary</label>
                                                                        <input name="second_parent_annual_salary" disabled id="mothers_annual_salary" placeholder="Ksh 2000"  type="text" value="{{$student->parent->last()->annual_salary}}"
                                                                            class="form-control">
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="col-md-4">
                                                                    <div class="position-relative form-group">
                                                                        ...
                                                                        <select name="second_parent_status" disabled id="second_parent_status"  autocomplete="off" class="form-control"  onchange="return secondParentDisabled()">
                                                                ...
                                                                <div class="col-md-4" id="">
                                                                    <div class="position-relative form-group">
                                                                        ...
                                                                        <input name="second_plwd_number" id="second_parent_plwd_id" placeholder="Plwd Number" disabled  type="text"
                                                                ...
                                                                <form name="add_name" id="add_name">
                                                                    <div class="table-responsive">
                                                                        <table class="table table-bordered" id="dynamic_field">
                                                                            ...
                                                                            <tr>
                                                                                <td><input type="text" disabled name="sibling_name[]" id="qty1" placeholder="Name" class="form-control name_list" value="{{$sibling->name}}" /></td>
                                                                                <!-- <td><input type="date" name="dob[]" id="rate1" placeholder="DOB" class="form-control name_list" /></td> -->
                                                                                <td><input type="text" disabled name="sibling_gender[]" id="rate1" placeholder="Gender" value="{{$sibling->gender}}"  class="form-control name_list" /></td>
                                                                                <td><input type="text" disabled name="sibling_school[]" id="rate1" placeholder="School" value="{{$sibling->school}}"  class="form-control name_list" /></td>
                                                                                <td><input type="text" disabled name="sibling_fees[]" id="rate1" placeholder="Fees" value="{{$sibling->fees}}"  class="form-control name_list" /></td>
                                                                ...
                                                                @foreach($student->attachments as $attachment)
                                                                    <div class="col-md-6">
                                                                        <div class="position-relative form-group">
                                                                            ...
                                                                            <input name="attachments[]" disabled id="attachments" type="file" class="form-control">
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="container text-center mt-4 mb-4">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-12 col-lg-5">
                                                                <button type="submit" class="btn btn-info " style="border-radius: 10px; width: 100%; ">Submit Application</button>
                                                            </div>
                                                        </div>  
                                                    </div>
                                                </div>
