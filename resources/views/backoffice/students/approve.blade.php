...
<div class="card">
    ...
    <div class="card-body p-4">
        ...
        <div class="row">
            <div class="col-sm-4">
                <div class="row">
                    ...
                    <div class="col-sm-12 text-secondary">
                        @if($student->parent->first())
                            {{$student->parent->first()->first_name}} {{$student->parent->first()->last_name ?? ''}}
                        @else
                            Blank
                        @endif
                    </div>
            ...
            <div class="col-sm-4">
                <div class="row">
                    ...
                    <div class="col-sm-12 text-secondary">
                        @if($student->parent->first())
                            {{$student->parent->first()->parental_status ?? 'Blank'}}
                        @else
                            Blank
                        @endif
                    </div>
        ...
        <p class="text-muted badge">Account Approved.</p>
       

     
        @else
        <p class="text-muted">Fill the following details.</p>
        <form class="mb-5" action="{{ route('admin.student.account.approve') }}" method="post">
            @csrf
