            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="container mt-3">
                        <form action="{{ route('admin.reports.bursary.pending')}}" method="GET">
                            <div class="row mb-2">
                                <div class="col">
                                ...
                                <div class="col">
                                    ...
                                    <div class="btn-group">
                                        ...
                                        <div class="dropdown-menu">
                                            <a class="dropdown-item" href="{{ route('admin.reports.pending_pdf', request()->query()) }}" target="_blank">Download To Pdf</a>
                                            <a class="dropdown-item" href="{{ route('admin.reports.pending_excel', request()->query()) }}">Download To Excel</a>
                                            <a class="dropdown-item" href="{{ route('admin.reports.pending_excel', request()->query()) }}">Download To Csv</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
