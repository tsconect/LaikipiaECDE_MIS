...
<div class="container mb-3">
    <div class="row justify-content-center mb-2">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">Rejected Applications by CDF Committee</div>
                ...
                <div class="card-body">
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                            <a class="dropdown-item" href="{{ route('admin.chief.rejected_pdf')}}" target="_blank">Download To Pdf</a>
                    ...
                    <table style="width: 100%;" id="example" class="table table-hover table-striped table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{$review->chief->user->first_name??"null"}} {{$review->chief->user->last_name??""}}</td>
                                <td>{{$review->percentage??'NULL'}}</td>
                                <td> {{$review->remark??'NULL'}}</td>
