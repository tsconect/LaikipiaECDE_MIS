                ...
                {{-- <div class="header-dots">
                    <div class="dropdown">
                        <button type="button" aria-haspopup="true" aria-expanded="false" data-toggle="dropdown"
                            ...
                            <span class="icon-wrapper icon-wrapper-alt rounded-circle text-white">
                                <span class="icon-wrapper-bg bg-primary text-white"></span>
                                <i class="icon text-white ion-android-apps "></i>
                            </span>
                        </button>
                            ...
                            <div class="dropdown-menu-header">
                                <div class="dropdown-menu-header-inner bg-plum-plate">
                                    ...
                                    <div class="menu-header-content text-white">
                                        ...
                                        <h6 class="menu-header-subtitle">Navigation Made Easier</h6>
                                    </div>
                                </div>
                            </div>
                            <div class="grid-menu grid-menu-xl grid-menu-3col">
                                <div class="no-gutters row">
                                    <div class="col-sm-6 col-xl-4">
                                        <button
                                            class="btn-icon-vertical btn-square btn-transition btn btn-outline-link" href="{{route('admin.teachers.all')}}">
                                            <i
