...
<div class="card-body">
            <h5 class="card-title">Reviewed  Applications ({{COUNT($data)}})</h5>
                    ...
                    <table style="width: 100%;" id="example" class="table table-hover table-striped table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{$committed_review ->percentage}} %</td>
                                <td>
                                ...
                                <td class="text-center">
                                    ...
                                    @else
                                    <a type="button" class="btn btn-outline-secondary" title="View Wards"
                                        href="{{route('admin.application.assign_cheque',$item->id)}}">
                                        <i class="fa fa-eye mr-1"></i>Assign Cheque
                                    </a>
                                    @endif
