...
<div class="card">
    ...
    <div class="card-body p-4">
        ...
        <div class="row">
            <div class="col-sm-4">
                <div class="row">
                    ...
                    <div class="col-sm-12 text-secondary">
                        {{$application->student->parent->first()->first_name ?? 'Blank'}}  {{$application->student->parent->first()->last_name ?? ''}}
                    </div>
                </div>
                <hr>
            </div>
            <div class="col-sm-4">
                <div class="row">
                    ...
                    <div class="col-sm-12 text-secondary">
                        {{$application->student->parent->first()->parent_status ?? 'Blank'}}
                    </div>
                </div>
                <hr>
            </div>
            <div class="col-sm-4">
                <div class="row">
                    ...
                    <div class="col-sm-12 text-secondary">
                        {{$application->student->parent->first()->who_pays_fees ?? 'Blank'}}
                    </div>
                </div>
                <hr>
            </div>
        ...
        <div class="row">
            <div class="col-sm-4">
                <div class="row">
                    ...
                    <div class="col-sm-12 text-secondary">
                        {{$application->student->parent->first()->occupation ?? 'Blank'}}
                    </div>
                </div>
                <hr>
            </div>
            <div class="col-sm-4">
                <div class="row">
                    ...
                    <div class="col-sm-12 text-secondary">
                        {{$application->student->parent->first()->phone ?? 'Blank'}}
                    </div>
                </div>
                <hr>
            </div>
            <div class="col-sm-4">
                <div class="row">
                    ...
                    <div class="col-sm-12 text-secondary">
                        {{$application->student->parent->first()->id_number ?? 'Blank'}}
                    </div>
                </div>
                <hr>
            </div>
        ...
        <div class="row">
            <div class="col-sm-4">
                <div class="row">
                    ...
                    <div class="col-sm-12 text-secondary">
                        {{$application->student->parent->first()->disability_status ?? 'Blank'}}
                    </div>
                </div>
                <hr>
            </div>
        ...
        <div class="row">
            <div class="col-sm-4">
                <div class="row">
                    ...
                    <div class="col-sm-12 text-secondary">
                        {{$application->student->school->school_name ?? 'Blank'}}
                    </div>
                </div>
                <hr>
            </div>
            <div class="col-sm-4">
                <div class="row">
                    ...
                    <div class="col-sm-12 text-secondary">
                        {{$application->student->school->level_of_study ?? 'Blank'}}
                    </div>
                </div>
                <hr>
            </div>
            <div class="col-sm-4">
                <div class="row">
                    ...
                    <div class="col-sm-12 text-secondary">
                        {{$application->student->school->school_category ?? 'Blank'}}
                    </div>
                </div>
                <hr>
            </div>
        ...
        <div class="row">
            <div class="col-sm-4">
                <div class="row">
                    ...
                    <div class="col-sm-12 text-secondary">
                        {{$application->student->school->admission_number ?? 'Blank'}}
                    </div>
                </div>
                <hr>
            </div>
            <div class="col-sm-4">
                <div class="row">
                    ...
                    <div class="col-sm-12 text-secondary">
                        {{$application->student->school->year_of_study ?? 'Blank'}}
                    </div>
                </div>
                <hr>
            </div>
            <div class="col-sm-4">
                <div class="row">
                    ...
                    <div class="col-sm-12 text-secondary">
                        {{$application->student->school->county ?? 'Blank'}}
                    </div>
                </div>
                <hr>
            </div>
        ...
        <div class="row">
            <div class="col-sm-4">
                <div class="row">
                    ...
                    <div class="col-sm-12 text-secondary">
                        {{$application->student->school->physical_address ?? 'Blank'}}
                    </div>
                </div>
                <hr>
            </div>
            <div class="col-sm-4">
                <div class="row">
                    ...
                    <div class="col-sm-12 text-secondary">
                        {{$application->student->school->contact_person ?? 'Blank'}}
                    </div>
                </div>
                <hr>
            </div>
        ...
        @if($application->student->attachments)
            <h2 class="card-title mb-3 mt-3">Attachements</h2>
            <div class="row">
            @foreach($application->student->attachments as $attachment)
                <div class="col-sm-3">
