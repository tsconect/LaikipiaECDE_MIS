...
<div class="card">
    ...
    <h2 class="card-title mb-3">Student Details</h2>
        ...
        @endif
        <hr>
        <h4>Chiefs/ Sub Chiefs Remark</h4>
      ...
      @else
        ...
        <form action="{{ route('chief.reviews.store') }}" method="post">
            @csrf
            ...
            <div class="form-group">
                ...
                <p class="text-muted">In a scale of 0 - 100, give a percentage of need for this application</p>
            ...
            <input type="hidden" name="chiefs_id" value="{{ Auth::user()->chief->id ?? '' }}" id="chiefs_id" class="form-control" required>
