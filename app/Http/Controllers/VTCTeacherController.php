...
class VTCTeacherController extends Controller
{
    //
    ...
    function view(VTCTeacher $id)
    {
        # code...
        // return $id;
        $data = $id;

        return view('backoffice.VocationalTrainingInstitute.Teachers.teacher_view_profile', compact('data'));
    }
    ...
    function create()
    {
        if (request()->has('vtc_id')) {
            ...
            return view('backoffice.VocationalTrainingInstitute.Teachers.create', compact('vtc_id'));
        }else{
    ...
    public function store(Request $request)
    {
        ...
        $_obj['tsc_number'] =$_obj['school_contact_tsc_number'];
        unset($_obj['school_contact_tsc_number']);
        $_obj['certification_attachment'] = basename($certificate_path);
    ...
    function update(Request $request, VTCTeacher $id)
    {
